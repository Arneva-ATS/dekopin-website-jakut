<header class="header sticky-bar {{ (request()->routeIs(['profil', 'berita', 'kontak', 'agenda', 'galeri', 'demografi', 'pengurus']) || isset($exception)) ? 'header-style-2 header-style-4' : '' }}">
    <div class="container">
                ...
                <div class="header-nav">
                    <nav class="nav-main-menu d-none d-xl-block">
                        <ul class="main-menu">
                            ...
                            <li class="has-children"><a class="{{ request()->routeIs('pengurus') ? 'active' : '' }}" href="{{ route('pengurus') }}">Pengurus</a></li>
