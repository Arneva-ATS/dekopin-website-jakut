...
<section class="section-box box-content-blog-2">
    <div class="container">
        <div class="text-center blog-head">
            ...
            <span class="btn btn-brand-4-sm">Berita Dekopinda Cirebon</span>

            <h2 class="heading-2 mb-20 mt-15">Berita & Informasi</h2>
            <p class="text-lg">Jelajahi Berita Dekopinda Cirebon untuk mendapatkan wawasan berharga, pendapat ahli, dan informasi terkini<br class="d-none d-lg-block"> tentang tren terbaru dalam dunia koperasi dan kesejahteraan.</p>
            ...
            <div class="col-lg-3">
                <div class="sidebar">
                    ...
                    <div class="sidebar-right sidebar-text">
                        <h5 class="mb-15">Tentang Dekopinwil Jawa Barat</h5>
                        <p class="text-md neutral-500">Dekopinwil Jawa Baratbertujuan untuk menjadi pendorong utama dalam memajukan koperasi di wilayah Jawa Barat, serta memberikan kontribusi nyata dalam pembangunan ekonomi yang lebih inklusif dan berkeadilan.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('https://cmscirebon.rkicoop.co.id/api.php?act=berita')
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                img.src = "https://cmscirebon.rkicoop.co.id/" + item.foto;
                img.alt = item.judul;
