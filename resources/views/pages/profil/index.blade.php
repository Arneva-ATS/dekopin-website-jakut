        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="padding-left-auto">
                    ...
                    <h2 class="display-2 mt-15 mb-25 px-2 fw-bold">Dekopinda Cirebon</h2>
                    <p class="text-xl mb-45 px-2">Dekopinda Cirebon bertujuan untuk menjadi pendorong utama dalam memajukan koperasi di wilayah Cirebon, serta memberikan kontribusi nyata dalam pembangunan ekonomi yang lebih inklusif dan berkeadilan.</p>
    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-6 mb-30">
                <h2 class="heading-2 text-white">Dekopinda Cirebon Berkomitmen untuk Memperkuat Gerakan Koperasi di Wilayah Cirebon</h2>
            </div>
            <div class="col-lg-6 mb-30">
